...
namespace SocialMediaForModelers.Migrations
{
    ...
    [Migration("20201121232749_addCreatedandModifiedTimesToSeed")]
    partial class addCreatedandModifiedTimesToSeed
    {
            ...
            modelBuilder.Entity("SocialMediaForModelers.Model.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "33edbe39-80ad-44fa-b1b5-46724f3991fa",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "90169416-0b49-4f1a-8377-905fff85ea6c",
                            ...
                            SecurityStamp = "7feac926-bbe0-4c50-9e4e-f28525447738",
            ...
            modelBuilder.Entity("SocialMediaForModelers.Model.PostComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Body = "I am a comment",
                            Created = new DateTime(2020, 11, 21, 23, 27, 49, 279, DateTimeKind.Utc).AddTicks(1441),
                            Modified = new DateTime(2020, 11, 21, 23, 27, 49, 279, DateTimeKind.Utc).AddTicks(1441),
                            UserId = "1234"
                        });
                });
